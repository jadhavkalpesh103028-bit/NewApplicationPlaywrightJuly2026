...
reporter: [ 
['html'],
 ['allure-playwright'], ['dot'], ['list'] ], 
 use: { 
 trace: 'on-first-retry', 
 screenshot: 'only-on-failure',
  video: 'retain-on-failure', 
  //headless: false, viewport: { width: 1280, height: 720 },
  //  // Set default viewport size for consistency ignoreHTTPSErrors: true,
  //  // Ignore SSL errors if necessary permissions: ['geolocation'],
  //  // Set necessary permissions for geolocation-based tests },
  //  //grep: /@master/, 
  projects: [ 
